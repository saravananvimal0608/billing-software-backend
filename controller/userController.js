...
export const resendOtp = async (req, res) => {
  ...
  try {
    ...
    // detect context: email update vs register/forgot
    const isEmailUpdate = !!user.tempEmail;
    const subject = isEmailUpdate ? "Verify your email" : "Resend OTP";
    const action = isEmailUpdate ? "Verify your email" : "verify your account";

    const isSent = await emailSend(user, otp, subject, action);
